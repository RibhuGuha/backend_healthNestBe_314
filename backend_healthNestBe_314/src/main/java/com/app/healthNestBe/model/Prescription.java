...
@Table(name = "\"Prescription\"", schema =  "\"healthnestbe_986\"")
@Data
...
public class Prescription {
  ...
  @Column(name = "\"ChiefComplaints\"", nullable = true )
  ...
  @Column(name = "\"Investigations\"", nullable = true )
  private String investigations;
  
	  
  @Column(name = "\"NextSteps\"", nullable = true )
  private String nextSteps;
  
	  
  @Column(name = "\"PersonalNotes\"", nullable = true )
  ...
  @Column(name = "\"Vitals\"")
  @AttributeOverrides({
            	@AttributeOverride(name = "bodyTemperature", column = @Column(name = "\"Vitals_BodyTemperature\"")) ,
            	@AttributeOverride(name = "bloodPressure", column = @Column(name = "\"Vitals_BloodPressure\"")) ,
            	@AttributeOverride(name = "oxygenSaturation", column = @Column(name = "\"Vitals_OxygenSaturation\"")) ,
            	@AttributeOverride(name = "height", column = @Column(name = "\"Vitals_Height\"")) ,
            	@AttributeOverride(name = "bloodGlucose", column = @Column(name = "\"Vitals_BloodGlucose\"")) ,
            	@AttributeOverride(name = "heartRate", column = @Column(name = "\"Vitals_HeartRate\"")) ,
            	@AttributeOverride(name = "respiratoryRate", column = @Column(name = "\"Vitals_RespiratoryRate\"")) ,
            	@AttributeOverride(name = "weight", column = @Column(name = "\"Vitals_Weight\"")) ,
            	@AttributeOverride(name = "bodyMassIndex", column = @Column(name = "\"Vitals_BodyMassIndex\""))  }) 
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"MedicationId\""), schema = "\"healthnestbe_986\"")
