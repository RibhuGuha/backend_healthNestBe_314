...
@Table(name = "\"Specialty\"", schema =  "\"healthnestbe_986\"")
@Data
...
public class Specialty {
  ...
  @Column(name = "\"DocSpeId\"", nullable = true )
  ...
  private String description;
	...
	@JoinColumn(name = "\"SpecialtyCategory\"", referencedColumnName = "\"Name\"", insertable = false, updatable = false)
...
@JoinTable(
            name="\"SpecialtyAvailableDocs\"",
            joinColumns = @JoinColumn( name="\"DocSpeId\""),
            inverseJoinColumns = @JoinColumn( name="\"DoctorId\""), schema = "\"healthnestbe_986\"")
private List<Doctor> availableDocs = new ArrayList<>();
