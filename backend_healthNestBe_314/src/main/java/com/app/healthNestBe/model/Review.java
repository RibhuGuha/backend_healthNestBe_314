...
@Entity(name = "Review")
@Table(name = "\"Review\"", schema =  "\"healthnestbe_986\"")
@Data
...
public class Review {
  ...
  private String feedback;
	...
	@JoinColumn(name = "\"ReviewReviewedAppointment\"", referencedColumnName = "\"AppointmentId\"", insertable = false, updatable = false)
	private Appointment reviewedAppointment;
	
	@Column(name = "\"ReviewReviewedAppointment\"")
	private Long reviewReviewedAppointment;
