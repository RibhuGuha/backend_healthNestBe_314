...
@Entity(name = "Payment")
@Table(name = "\"Payment\"", schema =  "\"healthnestbe_986\"")
@Data
...
public class Payment {
  ...
  private PaymentStatus status;
	...
	@JoinColumn(name = "\"PaymentPaidBy\"", referencedColumnName = "\"PatientId\"", insertable = false, updatable = false)
	private Patient paidBy;
	
	@Column(name = "\"PaymentPaidBy\"")
	private Long paymentPaidBy;

	@OneToOne(cascade = CascadeType.PERSIST)
	@JoinColumn(name = "\"PaymentPaidTo\"", referencedColumnName = "\"DoctorId\"", insertable = false, updatable = false)
	private Doctor paidTo;
	
	@Column(name = "\"PaymentPaidTo\"")
	private Long paymentPaidTo;
